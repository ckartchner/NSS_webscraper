...
def main():   
    ...
    try:
        addressToCheck = "http://www.nssio.org/find_section_overview.cfm"
...
def toCsv():
    outputWriter = csv.writer(open('NSSSection.csv', 'wb'), delimiter=';', quotechar='|', quoting=csv.QUOTE_MINIMAL)
